...
const TOWER_DEFS = {
  ...
  sniper2: {
    ...
    cost: 100, damage: 28, range: 5.6, fireRate: 0.35, projSpeed: 1200,
    path: 'sniper', level: 2,
    desc: '장거리 단발 저격 · 긴 재장전.'
  },
  sniper3: {
    key: 'sniper3', name: '대물저격 Lv.3', icon: '◎', color: '#3d9cd8',
    cost: 200, damage: 70, range: 6.5, fireRate: 0.4, projSpeed: 1300,
    path: 'sniper', level: 3,
    desc: '더 먼 거리에서 정밀 사격.'
  },
  sniper4: {
    key: 'sniper4', name: '레일건 Lv.4', icon: '◎', color: '#1e63d0',
    cost: 400, damage: 150, range: 7.6, fireRate: 0.45, projSpeed: 1500,
    path: 'sniper', level: 4,
    desc: '전자기로 가속된 초고속 탄환.'
  },
  sniper5: {
    key: 'sniper5', name: '광자포 Lv.5', icon: '◎', color: '#7b2cff',
    cost: 700, damage: 320, range: 9.0, fireRate: 0.55, projSpeed: 1800,
    path: 'sniper', level: 5,
    desc: '맵 전역에 닿는 광속 포격.'
  },
...
const ANT_KINDS = {
  ...
  tank:     { hp: 46,  speed: 36, reward: 7,   r: 10, color: '#1a0a05', perWaveHp: 0.025 },
  elite:    { hp: 90,  speed: 48, reward: 14,  r: 9,  color: '#4d1f0a', perWaveHp: 0.025 },
  bossMini: { hp: 320,  speed: 30, reward: 45,  r: 15, color: '#2d0a2a', perWaveHp: 0,    isBoss: true, tier: 'mini' },
  bossBig:  { hp: 780,  speed: 22, reward: 140, r: 20, color: '#3d0810', perWaveHp: 0,    isBoss: true, tier: 'big' },
  bossMega: { hp: 2600, speed: 14, reward: 550, r: 28, color: '#0c0616', perWaveHp: 0.01, isBoss: true, tier: 'mega' },
};
