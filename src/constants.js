...
const TOWER_DEFS = {
  ...
  sniper2: {
    ...
    cost: 100, damage: 42, range: 4.2, fireRate: 0.7, projSpeed: 1200,
    path: 'sniper', level: 2,
    desc: '장거리 고화력 단발 저격.'
  },
  sniper3: {
    key: 'sniper3', name: '대물저격 Lv.3', icon: '◎', color: '#3d9cd8',
    cost: 200, damage: 100, range: 4.8, fireRate: 0.75, projSpeed: 1300,
    path: 'sniper', level: 3,
    desc: '두꺼운 적도 일격에.'
  },
  sniper4: {
    key: 'sniper4', name: '레일건 Lv.4', icon: '◎', color: '#1e63d0',
    cost: 400, damage: 220, range: 5.4, fireRate: 0.8, projSpeed: 1500,
    path: 'sniper', level: 4,
    desc: '전자기로 가속된 초고속 탄환.'
  },
  sniper5: {
    key: 'sniper5', name: '광자포 Lv.5', icon: '◎', color: '#7b2cff',
    cost: 700, damage: 480, range: 6.0, fireRate: 0.9, projSpeed: 1800,
    path: 'sniper', level: 5,
    desc: '광속에 가까운 한 발로 소멸.'
  },
};
